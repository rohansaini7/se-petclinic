...
//@EnableJpaRepositories(basePackages = { "org.springframework.samples.petclinic.*", "petclinic.*" })
//@ComponentScan(basePackages = { "org.springframework.samples.petclinic.*", "petclinic.*" })
//@EntityScan(basePackages = { "org.springframework.samples.petclinic.*", "petclinic.*" })
